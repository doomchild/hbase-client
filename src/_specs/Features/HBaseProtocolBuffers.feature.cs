...
namespace _specs.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("HBase Protocol Buffers (protobuf)")]
    public partial class HBaseProtocolBuffersProtobufFeature
    {
        
        private static TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "HBaseProtocolBuffers.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "HBase Protocol Buffers (protobuf)", "In order to work with HBase content in the protobuf format\r\nAs an application dev" +
                    "eloper\r\nI want to be able to create and parse HBase protobuf content using basic" +
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("1", "alpha", "x", "", "hello world", "HBaseProtobuf_1AlphaX_HelloWorld", null)]
        [NUnit.Framework.TestCaseAttribute("1", "alpha", "", "4", "hello world", "HBaseProtobuf_1Alpha4_HelloWorld", null)]
        [NUnit.Framework.TestCaseAttribute("1", "alpha", "x", "4", "hello world", "HBaseProtobuf_1AlphaX4_HelloWorld", null)]
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Parse protobuf for single cell")]
        [NUnit.Framework.TestCaseAttribute("HBaseProtobuf_1Alpha_HelloWorld", "1", "alpha", "", "", "hello world", null)]
        [NUnit.Framework.TestCaseAttribute("HBaseProtobuf_1AlphaX_HelloWorld", "1", "alpha", "x", "", "hello world", null)]
        [NUnit.Framework.TestCaseAttribute("HBaseProtobuf_1Alpha4_HelloWorld", "1", "alpha", "", "4", "hello world", null)]
        [NUnit.Framework.TestCaseAttribute("HBaseProtobuf_1AlphaX4_HelloWorld", "1", "alpha", "x", "4", "hello world", null)]
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Create protobuf for a set of cells")]
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Parse protobuf for a set of cells")]
