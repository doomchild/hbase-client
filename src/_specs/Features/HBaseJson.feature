...
Scenario Outline: Create JSON for single cell
	...
	Then my JSON content should be equivalent to the resource called "<expected json>"
Examples:
...
Scenario Outline: Parse JSON for single cell
	Given I have JSON content equal to the resource called "<initial json>"
...
Scenario: Create JSON for a set of cells
	...
	Then my JSON content should be equivalent to the resource called "HBaseJson_Set_HelloWorld"

Scenario: Parse JSON for a set of cells
	Given I have JSON content equal to the resource called "HBaseJson_Set_HelloWorld"
