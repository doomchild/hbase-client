...
Scenario Outline: Create protobuf for single cell
	...
	Then my protobuf content should be equivalent to the resource called "<expected protobuf>"
Examples:
...
Scenario Outline: Parse protobuf for single cell
	Given I have protobuf content equal to the resource called "<initial protobuf>"
...
Scenario: Create protobuf for a set of cells
	...
	Then my protobuf content should be equivalent to the resource called "HBaseProtobuf_Set_HelloWorld"

Scenario: Parse protobuf for a set of cells
	Given I have protobuf content equal to the resource called "HBaseProtobuf_Set_HelloWorld"
